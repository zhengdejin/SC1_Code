...
#define PK_DBG_FUNC(fmt, arg...)    pr_debug(KERN_INFO  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_WARN(fmt, arg...)        pr_debug(KERN_WARNING  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_NOTICE(fmt, arg...)      pr_debug(KERN_NOTICE  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_INFO(fmt, arg...)        pr_debug(KERN_INFO  "%s: " fmt, __FUNCTION__ ,##arg)
#define PK_TRC_FUNC(f)              pr_debug("<%s>\n", __FUNCTION__);
#define PK_TRC_VERBOSE(fmt, arg...) pr_debug(fmt, ##arg)
#define PK_ERROR(fmt, arg...)       pr_debug(KERN_ERR "%s: " fmt, __FUNCTION__ ,##arg)
