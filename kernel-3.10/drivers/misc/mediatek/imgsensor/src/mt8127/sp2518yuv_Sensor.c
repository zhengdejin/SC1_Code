...
{
	SP2518_write_cmos_sensor(0xfd,0x00);
	SP2518_write_cmos_sensor(0x1b,0x0a);//maximum drv ability//0x1a 20131225
	SP2518_write_cmos_sensor(0x0e,0x01);
...
{
	SENSORDB("Ronlus SP2518GetResolution begin\r\n");
	...
	SENSORDB("Ronlus SP2518GetResolution: %d\n", pSensorResolution->SensorVideoWidth);
	return ERROR_NONE;
} /* SP2518GetResolution() */ 
...
{
	//UINT16 buffer = 0;
	SENSORDB("Ronlus SP2518_set_param_banding para = %d ---- \r\n", para); 
		...
		UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_YUV_CMD:
			SP2518YUVSensorSetting((FEATURE_ID)*pFeatureData32, *(pFeatureData32+1));//test ,del by sp_yjp,20130813
			break;
