...
static struct i2c_board_info __initdata kd_lens_dev = { I2C_BOARD_INFO(BU6424AF_DRVNAME, 0x19)};
...
static long BU6424AF_Ioctl(struct file * a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param)
{
    long i4RetValue = 0;
...
static int __init BU6424AF_i2C_init(void)
{
    ...
    if (platform_driver_register(&g_stBU6424AF_Driver)) {
        BU6424AFDB("[BU6424AF] failed to register BU6424AF driver\n");
        return -ENODEV;
    }
