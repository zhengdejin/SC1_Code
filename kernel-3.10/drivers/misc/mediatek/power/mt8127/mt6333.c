...
{
    kal_uint32 ret=0;
    pr_info(  "[chr_complete_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[thermal_sd_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[thermal_reg_in_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[thermal_reg_out_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[otg_thermal_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[otg_chrin_short_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[otg_drvcdt_short_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[chrwdt_flag_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[buck_vcore_oc_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[buck_vmem_oc_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[buck_vrf18_oc_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[buck_thermal_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[flash_en_timeout_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[flash_vled_short_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[flash_vled_open_int_handler]....\n");
...
{
    kal_uint32 ret=0;
    pr_info(  "[chr_plug_in_flash_int_handler]....\n");
...
static int mt6333_thread_kthread(void *x)
{
    ...
    pr_info(  "[mt6333_thread_kthread] enter\n");

    /* Run on a process content */
    while (1) {
        mutex_lock(&mt6333_mutex);

        pr_info(  "[mt6333_thread_kthread] running\n");
        ...
        pr_info(  "[INT] int_status_val_2=0x%x\n", int_status_val_2);
...
{
    pr_info(  "[mt6333_pmic_eint_irq] receive interrupt\n");
...
{
    pr_info(  "[MT6333_EINT_SETTING] start: CUST_EINT_MT6333_PMIC_NUM=%d\n",CUST_EINT_MT6333_PMIC_NUM);
    ...
    pr_info(  "[CUST_EINT] CUST_EINT_MT6333_PMIC_NUM=%d\n",           CUST_EINT_MT6333_PMIC_NUM);
    pr_info(  "[CUST_EINT] CUST_EINT_MT6333_PMIC_DEBOUNCE_CN=%d\n",   CUST_EINT_MT6333_PMIC_DEBOUNCE_CN);
    //pr_info(  "[CUST_EINT] CUST_EINT_MT6333_PMIC_POLARITY=%d\n",      CUST_EINT_MT6333_PMIC_POLARITY);
    //pr_info(  "[CUST_EINT] CUST_EINT_MT6333_PMIC_SENSITIVE=%d\n",     CUST_EINT_MT6333_PMIC_SENSITIVE);
    pr_info(  "[CUST_EINT] CUST_EINT_MT6333_PMIC_TYPE=%d\n",          CUST_EINT_MT6333_PMIC_TYPE);
    pr_info(  "[CUST_EINT] CUST_EINT_MT6333_PMIC_DEBOUNCE_EN=%d\n",   CUST_EINT_MT6333_PMIC_DEBOUNCE_EN);
}    
...
void MT6333_PMIC_INIT_SETTING_V1(void)
{
    ...
    {
        pr_info(  "[MT6333_PMIC_INIT_SETTING_V1] PMIC Chip = %x\n",g_mt6333_cid);
        pr_info(  "[MT6333_PMIC_INIT_SETTING_V1] 20130514\n");
    ...
    {
        pr_info(  "[MT6333_PMIC_INIT_SETTING_V1] Unknown PMIC Chip (%x)\n",g_mt6333_cid);
    }

    pr_info(  "after MT6333 init : Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n", 
    ...
    // DCT
    pr_info(  "[MT6333_PMIC_INIT_SETTING_V1] pmu_drv_tool_customization_init\n");
    pr_info(  "MT6333 before: Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n", 
    ...
    pr_info(  "MT6333 after: Reg[%x]=0x%x,Reg[%x]=0x%x,Reg[%x]=0x%x\n", 
        0x68, mt6333_get_reg_value(0x68),
        0x80, mt6333_get_reg_value(0x80),
        0x9F, mt6333_get_reg_value(0x9F)
        );
...
{             
    ...
    pr_info(  "[mt6333_driver_probe] g_mt6333_cid=0x%x\n", g_mt6333_cid);
    ...
    pr_info(  "[MT6333_PMIC_INIT_SETTING_V1] Done\n");

    //MT6333 Interrupt Service
    //MT6333_EINT_SETTING();
    //pr_info(  "[MT6333_EINT_SETTING] Done\n");
    
    kthread_run(mt6333_thread_kthread, NULL, "mt6333_thread_kthread");
    pr_info(  "[mt6333_thread_kthread] Done\n");
