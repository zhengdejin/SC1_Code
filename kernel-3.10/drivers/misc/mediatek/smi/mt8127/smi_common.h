...
#define SMIMSG(string, args...)	pr_info("SMI[pid=%d]"string,current->tgid,##args)
#define SMITMP(string, args...)  pr_info("SMI[pid=%d]"string,current->tgid,##args)
#define SMIERR(string, args...) do{\
	pr_err("SMIerror: "string, ##args); \
