...
static int smi_bwc_config( MTK_SMI_BWC_CONFIG* p_conf , unsigned long * pu4LocalCnt)
{
    ...
    else
    {
        ...
        {
            SMIMSG("Too many turning off for global SMI profile:%d,%ld\n" , 
        ...
        if(NULL != pu4LocalCnt)
        {
            ...
            {
                SMIMSG("Process : %s did too many turning off for local SMI profile:%d,%ld\n" , 
