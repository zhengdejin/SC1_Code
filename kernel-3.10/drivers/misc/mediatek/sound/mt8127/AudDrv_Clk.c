...
inline void TURN_ON_AFE_CLOCK(void)
{
    ...
    {
        pr_err("Aud enable_clock MT_CG_INFRA_AUDIO fail !\n");
    }
...
inline void TURN_OFF_AFE_CLOCK(void)
{
    ...
    {
        pr_err("Aud disable_clock MT_CG_AUDIO_AFE fail !\n");
    }
    if (disable_clock(MT_CG_INFRA_AUDIO, "AUDIO"))
    {
        pr_err("Aud disable_clock MT_CG_INFRA_AUDIO fail !\n");
    }
}
...
inline void TURN_ON_HDMI_CLOCK(void)
{
    ...
    {
        pr_err("Aud enable_clock MT_CG_AUDIO_HDMI_CK fail !\n");
    }
}
...
inline void TURN_OFF_HDMI_CLOCK(void)
{
    ...
    {
        pr_err("Aud disable_clock MT_CG_AUDIO_HDMI_CK fail !\n");
    }
    if (disable_clock(MT_CG_INFRA_AUDIO, "AUDIO"))
    {
        pr_err("Aud disable_clock MT_CG_INFRA_AUDIO fail !\n");
...
inline void TURN_ON_APLL_TUNER_CLOCK(void)
{
    ...
    {
        pr_err("Aud enable_clock MT_CG_AUDIO_APLL_TUNER_CK fail !\n");
    }
}
...
inline void TURN_OFF_APLL_TUNER_CLOCK(void)
{
    ...
    {
        pr_err("Aud disable_clock MT_CG_AUDIO_APLL_TUNER_CK fail !\n");
    }
    if (disable_clock(MT_CG_INFRA_AUDIO, "AUDIO"))
    {
        pr_err("Aud disable_clock MT_CG_INFRA_AUDIO fail !\n");
...
inline void TURN_ON_SPDIF_CLOCK(void)
{
    ...
    {
        pr_err("Aud enable_clock MT_CG_AUDIO_SPDF_CK fail !\n");
    }
}
...
inline void TURN_OFF_SPDIF_CLOCK(void)
{
    ...
    {
        pr_err("disable_clock MT_CG_AUDIO_SPDF_CK fail !\n");
    }
    if (disable_clock(MT_CG_INFRA_AUDIO, "AUDIO"))
    {
        pr_err("Aud disable_clock MT_CG_INFRA_AUDIO fail !\n");
...
void AudDrv_TOP_Apll_Clk_On(void)
{
    ...
    if (Aud_TOP_APLL_Clk_cntr == 0)
    {
        ...
        {
            pr_err("Aud enable_clock MT_CG_TOP_PDN_APLL fail !!!\n");
        }
        */
#endif
    }
...
void AudDrv_TOP_Apll_Clk_Off(void)
{
    ...
    if (Aud_TOP_APLL_Clk_cntr == 0)
    {
        ...
        {
            pr_err("disable_clock MT_CG_TOP_PDN_APLL fail");
        }
        */
#endif
    }
