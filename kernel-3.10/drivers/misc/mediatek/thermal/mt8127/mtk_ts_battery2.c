...
do {                                    \
	if (mtktsbattery2_debug_log) {                \
		pr_info( "Power/battery2_Thermal" fmt, ##args); \
	}                                   \
} while(0)
...
static INT16 BattThermistorConverTemp(INT32 Res)
{
    ...
    #if 0
    pr_info( "Power/battery2_Thermal" "BattThermistorConverTemp() : TBatt_Value = %d\n",TBatt_Value);
    pr_info( "Power/battery2_Thermal" "BattThermistorConverTemp() : Res = %d\n",Res);
    pr_info( "Power/battery2_Thermal" "BattThermistorConverTemp() : RES1 = %d\n",RES1);
    pr_info( "Power/battery2_Thermal" "BattThermistorConverTemp() : RES2 = %d\n",RES2);
    pr_info( "Power/battery2_Thermal" "BattThermistorConverTemp() : TMP1 = %d\n",TMP1);
    pr_info( "Power/battery2_Thermal" "BattThermistorConverTemp() : TMP2 = %d\n",TMP2);
    #endif
